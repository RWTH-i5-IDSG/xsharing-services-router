 ...
 */
public interface MBDataRepository {
    List<MBPlaceEntity> getAllIXSIBikeStations();
    List<MBPlaceEntity> getAllIXSICarStations();
    List<MBPlaceInavailability> getInavailabilities();
}
