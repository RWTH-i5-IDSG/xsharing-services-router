...
/**
 * Caller implementation for sending details requests from admin interface
 *
 * @author Max Wiederhold <maximilian.wiederhold@rwth-aachen.de>
 */
@Slf4j
public class DetailsCaller implements Caller {
    @Inject private JMSContext context;

    @Resource(mappedName = JMSConfig.DETAILS_QUEUE_NAME)
    private Queue minQ;
