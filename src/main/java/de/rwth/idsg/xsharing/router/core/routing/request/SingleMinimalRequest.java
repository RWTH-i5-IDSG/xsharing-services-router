...
/**
 * Utility class for mapping a single minimal request to input in the service
 *
...
@AllArgsConstructor
@NoArgsConstructor
public class SingleMinimalRequest {

    // REQUIRED PARAMETERS

    private GeoCoord startPoint;
    private GeoCoord endPoint;
    ...
    private Optional<List<SharingStationType>> stationTypes;
}
