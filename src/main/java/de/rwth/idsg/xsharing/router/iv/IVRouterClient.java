 ...
 */
public interface IVRouterClient {
    ShortestPathsResult getShortestPaths(ShortestPathsRequest request);
    DistanceMatrixResult getDistanceMatrix(DistanceMatrixRequest request);
}
