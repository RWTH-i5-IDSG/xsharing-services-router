 ...
 */
public class GeoCoordDeserializer extends JsonDeserializer<GeoCoord> {

    @Override
    public GeoCoord deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
