...
public class WalkingLeg extends RouteLeg implements Serializable {

    @Transient
    private boolean reversed = false;

    public WalkingLeg(LegType type, GeoCoord from, GeoCoord to, double distance, int time,
    ...
    /**
     * This is used to change the orientation of the route at run time! (for return trips!)
     * (Swaps from and to coordinates)
     */
    public void reverse() {
        GeoCoord temp = getFrom();
        setFrom(getTo());
        setTo(temp);
