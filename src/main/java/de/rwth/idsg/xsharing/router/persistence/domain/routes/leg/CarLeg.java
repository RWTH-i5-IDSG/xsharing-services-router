...
import static de.rwth.idsg.xsharing.router.Constants.DatabaseConstants.CAR_LEG_TRANSFER_TIME;
...
public class CarLeg extends RouteLeg implements SharingLeg, Serializable {

    public CarLeg(LegType type, GeoCoord from, GeoCoord to, double distance, int time,
