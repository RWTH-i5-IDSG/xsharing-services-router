 ...
 */
public interface SharingRouterService {
    RouteMinimalRepresentation getRoutesForLowerBounds(SingleMinimalRequest request) throws RouteBuilderException;
    RouteMinimalRepresentation getRoutes(SingleMinimalRequest request) throws RouteBuilderException;
    RouteCompactRepresentation getRoutes(CompactRequest request) throws RouteBuilderException;
    RouteDetailsRepresentation getRoutes(DetailsRequest request) throws RouteBuilderException;
}
