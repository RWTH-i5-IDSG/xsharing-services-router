...
/**
 * Interface for connecting to the ASEAG server for import of bus stop points
 *
 * @author Max Wiederhold <maximilian.wiederhold@rwth-aachen.de>
 */
public interface AseagClient {
    List<StopPoint> getAseagStops() throws UraRequestParseException;
}
