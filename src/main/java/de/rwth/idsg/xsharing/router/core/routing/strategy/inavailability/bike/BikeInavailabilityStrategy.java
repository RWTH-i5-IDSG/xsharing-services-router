 ...
 * @since 26.05.2016
 */
public interface BikeInavailabilityStrategy extends InavailabilityStrategy {

    /**
     * Checks the overlapping with Bike as last leg
     *
    ...
    /**
     * Checks the overlapping with Walk as last leg (after a Bike leg)
     *
     * @return true     if there is an overlap
     */
    boolean overlaps(int stayTime, RouteLegList legs,
