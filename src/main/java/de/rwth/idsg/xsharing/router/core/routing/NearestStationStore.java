 ...
 */
public interface NearestStationStore {
    void reset();

    void addBikeStations(GeoCoord at, List<BikeStation> stationList);
    void addCarStations(GeoCoord at, List<CarStation> stationList);

    List<BikeStation> allNearestBikeStations(GeoCoord at);
    List<CarStation> allNearestCarStations(GeoCoord at);
}
