...
public interface RouteBuilderService {
    boolean prepareCore(List<RasterPoint> databasePoints, Double granularity);
    void prepareAllWalkingLegs();
    void prepareAllSharingLegs();
    void buildNearestStationsMap();
}
